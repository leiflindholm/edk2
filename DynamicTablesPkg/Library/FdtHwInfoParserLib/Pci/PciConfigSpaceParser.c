  ...
  )
{
  ...
  Data = (UINT8 *)FdtGetProperty (Fdt, HostPciNode, "linux,pci-domain", &DataSize);
  ...
  )
{
  ...
  Data = (UINT8 *)FdtGetProperty (Fdt, HostPciNode, "bus-range", &DataSize);
  if ((Data == NULL) || (DataSize < 0)) {
  ...
  )
{
  ...
  Data = (UINT8 *)FdtGetProperty (Fdt, HostPciNode, "ranges", &DataSize);
  if ((Data == NULL) ||
      (DataSize < 0) ||
  ...
  )
{
  ...
  Data = (UINT8 *)FdtGetProperty (Fdt, HostPciNode, "interrupt-map", &DataSize);
  if ((Data == NULL) || (DataSize <= 0)) {
    DEBUG ((
      DEBUG_WARN,
  ...
  IrqMapMask = (UINT8 *)FdtGetProperty (
                          Fdt,
                          HostPciNode,
                          "interrupt-map-mask",
                          &IrqMapMaskSize
  ...
  )
{
  ...
  Data = (UINT8 *)FdtGetProperty (Fdt, HostPciNode, "reg", &DataSize);
  if ((Data == NULL) ||
